...
const seedDatabase = async () => {
  try {
    ...
    const artworkData = [
      { title: 'Sunset Over Mountains', desc: 'A breathtaking view of sunset over mountain ranges painted in vibrant oil colors.', price: 450, cat: 1, artist: 0, medium: 'oil', style: 'landscape' },
      { title: 'Urban Portrait Study', desc: 'A modern portrait capturing the essence of urban life through bold strokes.', price: 320, cat: 0, artist: 0, medium: 'acrylic', style: 'portrait' },
      { title: 'Abstract Harmony', desc: 'An abstract composition exploring the harmony between colors and forms.', price: 580, cat: 2, artist: 1, medium: 'acrylic', style: 'abstract' },
      { title: 'Garden Roses', desc: 'Delicate watercolor painting of blooming roses in a garden setting.', price: 280, cat: 3, artist: 0, medium: 'watercolor', style: 'realistic' },
      { title: 'Digital Dreams', desc: 'A stunning digital illustration exploring surreal dreamscapes.', price: 250, cat: 4, artist: 1, medium: 'digital', style: 'modern' },
      { title: 'Classic Pencil Portrait', desc: 'A detailed pencil sketch portrait showing incredible detail and shading.', price: 180, cat: 7, artist: 0, medium: 'pencil', style: 'realistic' },
      { title: 'Neon City Nights', desc: 'Pop art inspired cityscape with bold neon colors and geometric shapes.', price: 420, cat: 5, artist: 1, medium: 'digital', style: 'contemporary' },
      { title: 'Ocean Serenity', desc: 'A calming seascape painted in soft watercolors capturing the morning light.', price: 350, cat: 1, artist: 0, medium: 'watercolor', style: 'impressionist' },
      { title: 'Charcoal Expression', desc: 'An expressive charcoal drawing exploring human emotions.', price: 220, cat: 7, artist: 0, medium: 'charcoal', style: 'modern' },
      { title: 'Geometric Fusion', desc: 'A modern abstract piece combining geometric shapes with organic forms.', price: 490, cat: 2, artist: 1, medium: 'acrylic', style: 'abstract' },
      { title: 'Vintage Still Life', desc: 'A classic still life painting of vintage objects with rich warm tones.', price: 310, cat: 3, artist: 0, medium: 'oil', style: 'realistic' },
      { title: 'Tropical Paradise', desc: 'A vibrant landscape of a tropical paradise with palm trees and turquoise waters.', price: 380, cat: 1, artist: 0, medium: 'acrylic', style: 'landscape' },
    ];
